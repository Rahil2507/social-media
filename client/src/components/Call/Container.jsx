...
function Container({data}) {
  ...
  //       if (!document.getElementById("video-local-zego")) {
  ...
  return <div className="border-conversation-border bottom-1 w-full bg-conversation-panel-background flex flex-col h-[100vh] overflow-hidden items-center justify-center text-white">
    ...
    {(!callAccepted || data.callType === "audio" ) && <div className="my-12">
      <Image src={data.profilePicture} height={300} width={300} className="rounded-full"/>
    </div> }
    <div className="my-5 relative" id="remote-video">
      <div className="absolute bottom-0 right-0" id="local-audio"></div>
    </div>
