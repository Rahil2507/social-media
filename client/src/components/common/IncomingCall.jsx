...
function IncomingCall() {
  ...
  const acceptCall = () => {
    dispatch({type: reducerCases.SET_VOICE_CALL, voiceCall: {...incomingVoiceCall, type: "in-coming"}})
  ...
  return <div className="flex-col md:flex-row h-full md:h-24 w-full md:w-80 absolute md:fixed md:bottom-8 mb-0 md:right-6 z-50 rounded-sm flex gap-5 items-center justify-center md:justify-start p-4 bg-conversation-panel-background text-white drop-shadow-2xl border-icon-green border-2 py-14">
    <div className="mb-10 md:mb-0">
      <Image className="block md:hidden" src={incomingVoiceCall.profilePicture} alt="avatar" width={150} height={150} />
      <Image className="hidden md:block" src={incomingVoiceCall.profilePicture} alt="avatar" width={70} height={70} />
    </div>
    <div className="flex flex-col md:block items-center">
      <div className="text-[35px] md:text-[18px]">{incomingVoiceCall.name}</div>
      <div className="text-lg font-thin md:font-normal md:text-xs">Incoming Voice Call</div>
