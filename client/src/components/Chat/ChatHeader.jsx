...
function ChatHeader() {
  ...
  return <div className="h-16 px-4 py-3 flex justify-between items-center bg-panel-header-background z-10">
    <div className="flex items-center justify-center gap-6">
      <BiArrowBack  onClick={() => dispatch({type : reducerCases.SET_EXIT_CHAT})} className="block md:hidden text-panel-header-icon cursor-pointer text-2xl" />
    ...
    <div className="flex gap-6">
      ...
      <BsThreeDotsVertical onClick={(e) => showContextMenu(e)} id="context-opener" className="hidden md:block text-panel-header-icon cursor-pointer text-xl" />
