    ...
    switch(action.type) {
        ...
        case reducerCases.SET_ONLINE_USERS:
            ...
            case reducerCases.SET_CONTACT_SEARCH:
                ...
                return {
                    ...state, filteredContacts, contactSearch: action.contactSearch
                }
            ...
            case reducerCases.SET_INCOMING_VOICE_CALL:
                return {
                    ...state, incomingVoiceCall: action.incomingVoiceCall
                }
            case reducerCases.SET_INCOMING_VIDEO_CALL:
                return {
                    ...state, incomingVideoCall: action.incomingVideoCall
                }
